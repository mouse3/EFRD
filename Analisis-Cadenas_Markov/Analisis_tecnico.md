...
Tras someter al **Protocolo EFRD v3.2** a una simulación de transición de estados, se observa que el sistema converge a un vector estacionario $\pi = [0.227, 0.351, 0.286, 0.135]$.
